...
let enlace2 = { contextInfo: { externalAdReply: { showAdAttribution: true, mediaUrl: yt, mediaType: 'VIDEO', description: '', title: wm, body: 'The Shizzy bot', thumbnailUrl: await(await fetch(img)).buffer(), sourceUrl: yt }}}
...
conn.sendHydrated(m.chat, info, wm, pp, 'https://github.com/andymrlit', 'Shizzy md', null, null, [
